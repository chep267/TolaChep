...
function Saved(props) {
    return (
        <svg width={20} height={24} viewBox="0 0 20 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            />
            <rect x={5.33301} y={7.33325} width={9.33333} height={2.33333} rx={1.16667} fill="url(#paint1_linear_10770_7098)" />
            <defs>
                <linearGradient id="paint0_linear_10770_7098" x1={9.99984} y1={0.333252} x2={9.99984} y2={23.6666} gradientUnits="userSpaceOnUse">
                    <stop stopColor="#7FFF41" />
                    <stop offset={1} stopColor="#52C41A" />
                </linearGradient>
                <linearGradient id="paint1_linear_10770_7098" x1={9.99967} y1={8.11103} x2={9.99967} y2={9.66659} gradientUnits="userSpaceOnUse">
